import {addTasksAC, addTodolistTasksAC, changeCheckboxAC, changeTasksAC, removeTasksAC} from "./TasksReducer";
...
test('correct task should be added to correct array', () => {
    ...
    const action = addTasksAC('todolistId2', 'juice')
...
test('title of tasks should be changed', () => {
    ...
    const action = changeTasksAC('todolistId2','1', 'Hello')
...
test('new array should be added when new todolist is added', () => {
    ...
    const action = addTodolistTasksAC()
